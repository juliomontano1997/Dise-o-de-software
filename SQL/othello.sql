...
* boolean
*/
CREATE OR REPLACE FUNCTION mg_get_startSession(IN i_sessionID INT, IN o_board INTEGER[], IN o_colorPlayer1 VARCHAR(30), IN o_colorPlayer2 VARCHAR(30))
RETURNS BOOLEAN AS
$body$
BEGIN 	
...
mg_get_session_stadistic (IN i_sessionID    INT, OUT o_winsPlayer1 INT, OUT o_winsPlayer2 INT, OUT o_ties INT, OUT o_amountGames INT, OUT o_numberActualgame INT)
RETURNS
SETOF RECORD AS 
$body$
BEGIN 	
